...
def main():
   ...
   # path_merge_linux='/home/juliaponcela/at_NICO/Dropbox_collaboration_patterns/Data/Merged_LinkedIn_WoS/'
    ...
    print "# authors involved:  ", len(lista_authors_merge) #type: INT




    path_merge_cluster='/home/juliaponcela/at_NICO/Dropbox_collaboration_patterns/Data/Merged_LinkedIn_WoS/'
    file_pickle = open(path_merge_cluster+"dict_paper_list_authors"+string_lines+".pickle",'rb')
    dict_paper_list_authors  = pickle.load(file_pickle)
 
    list_paper_ids=dict_paper_list_authors.keys()  # str
    ...
    for file_citations in  sorted(lista_files):
        ...
        with gzip.open(path+file_citations,'r') as f:        
             for line in f:            
                ...
                paper=lista_line[0].replace("WOS:","")
                ...
                ref_overlap=list(set(list_ref) & set(list_paper_ids))
        ...
        print file_citations, "num lines read:", cont, "   with useful info:",cont_useful_lines_adding_cit
