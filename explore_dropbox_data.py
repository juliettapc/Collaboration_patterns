...
def main():
    ...
    name1="../Results/Summary_count_types_files_actions_actors"+testing_string+".dat"
    file1= open(name1, 'wt')
   ...
   ##### NOTES: 
    ...
    path_name_h="../Results/Hist_num_actors_per_file"+testing_string+".dat"
    ...
    path_name_h="../Results/Hist_num_actions_per_file"+testing_string+".dat"
    ...
    path_name_h="../Results/Hist_num_actions_per_actor"+testing_string+".dat"
    ...
    path_name_h="../Results/Hist_num_actions_per_folder"+testing_string+".dat"
    histograma_gral.histogram(list_num_actions_per_folder, path_name_h)


    filename_pickle="../Results/Dict_folder_id_num_actions.pickle"
    ...
    path_name_h="../Results/Hist_num_actors_per_folder"+testing_string+".dat"
    histograma_gral.histogram(list_number_actors_per_folder, path_name_h)


    filename_pickle="../Results/Dict_folder_id_num_actors.pickle"
    pickle.dump(dict_folder_id_num_actions, open(filename_pickle, 'wb'))
    ...
    path_name_h="../Results/Hist_time_intervals_between_edits_folder"+testing_string+".dat"
    histograma_gral.histogram(list_time_intervals, path_name_h)



    path_name_h="../Results/Hist_time_spans_editing_history_folder"+testing_string+".dat"
   ...
   ##################
    ...
    print "first date:", lista[0], " and last:",lista[-1]
